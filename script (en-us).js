window.onload = function () {
	...
	function gameOver () 
	{
		...
		ctx.strokeText("Game Over", centerX, centerY - 150);
		ctx.fillText("Game Over", centerX, centerY - 150);
		ctx.font = "25px bold sans-serif ";
		ctx.strokeText("Press SPACEBAR to restart", centerX, centerY - 80);
		ctx.fillText("Press SPACEBAR to restart", centerX, centerY - 80);
		ctx.restore();
	}
